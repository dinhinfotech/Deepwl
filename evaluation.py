...
def evaluate(adjacency_path=None, node_label_folder=None, all_gene_path=None, train_gene_path=None, train_label_path=None,
             n_iters=None, n_hops=None, n_clusters=None, svm_paras=None, save_file_path=None):
    
    all_genes = util.load_list_from_file(all_gene_path)
    list_training_genes = util.load_list_from_file(train_gene_path)
    list_training_labels = util.load_list_from_file(train_label_path)
    ...
    for n_cluster in n_clusters:
        ...
        for n_iter in n_iters:
            ...
            for n_hop in n_hops:
                ...
                sys.stdout.flush()
                G = util.deepwl_separate(graph=graph, iters_features=iters_features, n_hop=n_hop)
